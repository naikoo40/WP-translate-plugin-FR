...
$event_category = new \GDCalendar\Models\Taxonomy\EventCategory($queried_object->term_id);

$events = \GDCalendar\Models\PostTypes\Event::get(array(
    'post_status' => 'publish',
    'tax_query' => array(
        array(
            'taxonomy' => \GDCalendar\Models\Taxonomy\EventCategory::get_taxonomy(),
            'terms' => $event_category->get_id(),
        ),
    ),
));
?>
